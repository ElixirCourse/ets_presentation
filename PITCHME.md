...
* Ако една таблица ще има множество четения често пъти, които не са прекъсвани от писане, можем да я маркираме като read_concurrency: true.
* Ако го направим и често редуваме четения и писания, достъпът до таблицата ще се влоши.

---
### Опции четене и писане

* Ако една таблица ще има множество промени, които не променят един и същи запис - insert, delete и подобни функции, можем да я маркираме като write_concurrency: true.
...
* Въведени са за да допринесат за оптимизирането на точно определени случаи и е добре да се ползват само в тези случаи.
